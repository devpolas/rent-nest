...
import RentalRequestTableToolbar from "./rental-request-table-toolbar";

interface DataTableProps<TData extends RowData> {
  columns: ColumnDef<TableFeatures, TData>[];
  data: TData[];
}
export default function RentalTable<TData extends RowData>({
  columns,
  data,
  ...
  return (
    <div className='overflow-hidden'>
      <div>
        <RentalRequestTableToolbar table={table} />
      </div>
      <Table>
        <TableHeader>
