...
export default function HeroPropertyPreview() {
  return (
    <div className='relative mx-auto pb-28 sm:pb-24 w-full max-w-xl'>
      {/* Carousel */}
      <HeroCarousel />
      ...
      <Card className='top-4 right-4 sm:-right-5 absolute z-20 glass-card'>
        <CardContent className='flex items-center gap-3 p-3'>
          ...
          <div>
            <Large className='text-white leading-none'>4.9</Large>
      ...
      {/* Stats */}
      <div className='-bottom-10 left-1/2 absolute gap-2 sm:gap-3 grid grid-cols-2 w-[92%] -translate-x-1/2'>
